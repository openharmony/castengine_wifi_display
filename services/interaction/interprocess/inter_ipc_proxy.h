...
#ifndef OHOS_SHARING_INTER_IPC_INTERFACE_PROXY_H
#define OHOS_SHARING_INTER_IPC_INTERFACE_PROXY_H
...
public:
    ...
    explicit InterIpcProxy(const sptr<IRemoteObject> &impl);
...
private:
    static inline BrokerDelegator<InterIpcProxy> delegator_;
};
